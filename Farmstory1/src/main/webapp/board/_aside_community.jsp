    ...
    <section class="cate5">
        <aside>
            ...
            <ul class="lnb">
                ...
                <li class="<%= cate.equals("fnq") ? "on":"off"%>"><a href="/Farmstory1/board/list.jsp?group=community&cate=faq">자주하는질문</a></li>
            </ul>

        </aside>
        <article>
            <nav>
                <img src="/Farmstory1/img/sub_nav_tit_cate5_tit_<%= cate %>.png" alt="이벤트"/>
                <p>
                    HOME > 커뮤니티 > 

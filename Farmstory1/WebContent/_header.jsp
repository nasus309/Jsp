    ...
    <div id="wrapper">
        <header>
            ...
            <ul class="gnb">
                ...
                <li><a href="/Farmstory1/board/list.jsp?group=croptalk&cate=story">농작물이야기</a></li> <!-- cate 하는 이유 : 클릭했을 때 제일처믕 화면이 농작물이야기 이니까 -->
                <li><a href="/Farmstory1/board/list.jsp?group=event&cate=event">이벤트</a></li>
                <li><a href="/Farmstory1/board/list.jsp?group=community&cate=notice">커뮤니티</a></li> <!-- cate 하는 이유 : 클릭했을 때 제일처믕 화면이 공지사항 이니까 -->
            </ul>
        </header>
